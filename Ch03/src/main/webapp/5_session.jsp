...
<html>
	<head>
		...
		<%--
			...
			- 클라이언트에 대응되는 객체, 서버에 기록되는 클라이언트 고유 번호(Session Table)
	...
	<body>
		...
		<%
			...
			// session table에 user 컬럼명으로 user 객체 저장 
			session.setAttribute("userColumn", user);
			
			// session table에 저장된 userColumn 컬럼 값을 가져옴  -본래 object 타입인데 UserVo 타입으로 캐스팅 해줌 
