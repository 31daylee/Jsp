		...
		<form id="formUser" action="/Farmstory1/user/registerProc.jsp" method="post">
			<table border="1">
				...
				<tbody>
					<tr>
						<td>아이디</td>
						<td><input type="text" name="uid" placeholder="아이디입력">
							<button type="button" id="btnCheckUid">
								<img src="/Farmstory1/images/chk_id.gif" alt="중복확인">
							</button> <span class="resultId"></span>
						</td>
					</tr>
					<tr>
						<td>비밀번호</td>
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" name="hp" placeholder="- 포함 13자리 입력 "
							minlength="13" maxlength="13"><span id="resultHp"></span>
						</td>
					</tr>
					<tr>
						<td>주소</td>
