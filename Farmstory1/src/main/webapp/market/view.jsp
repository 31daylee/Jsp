        ...
        <div id ="sub">
            ...
            <section class="market"> 
                ...
                <article class="content">
                    ...
                    <h3>기본정보</h3>
                    <div class="basic">
                        <img src="/Farmstory1/images/market_item_thumb.jpg" alt="딸기">
                        <a href="./order.html" class="btnOrder">
                            <img src="/Farmstory1/images/market_btn_order.gif" alt="바로구매하기">
                        </a>
                        <table border="0">
                            <tbody>
                                <tr>
                    ...
                    <h3>상품설명</h3>
                    <div class="detail"><img src="/Farmstory1/images/market_detail_sample.jpg" alt="상품설명"></div>
                    <h3>배송정보</h3>
                    <div class="delivery"><p>입금하신 이후 택배송장번호는 SMS(문자서비스)를 통해 고객님께 안내해드립니다.</p></div>
                    <h3>교환/반품</h3>
                    <div class="exchange">
                        <table border="0">
                            <tbody>
